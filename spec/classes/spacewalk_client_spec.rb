...
describe 'spacewalk_client', :type => 'class' do
  ...
  context "Should fail for unsupported CentOS version" do
    ...
    it do
      should compile.and_raise_error(/spacewalk_client - Unsupported RHEL\/CentOS Version: 5/)
    end
  end
  ...
  context "Should fail for unsupported Ubuntu version" do
    ...
    it do
      should compile.and_raise_error(/spacewalk_client - Unsupported Ubuntu Version: 5/)
    end
  end
  ...
  context "Should fail for unsupported OS" do
    ...
    it do
      should compile.and_raise_error(/Unsupported Operating System: Windows/)
    end
  end
